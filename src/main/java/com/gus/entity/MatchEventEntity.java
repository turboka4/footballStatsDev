...
public class MatchEventEntity {
    ...
    public int getEventMatchId() { return event_match_id; }

    public String getEventType() { return event_type; }

    public int getEventMinute() { return event_minute; }

    public String getEventTeam() { return event_team; }

    public String getEventPlayer() { return event_player; }

    public int getEventPlayerId() { return event_player_id; }

    public String getEventResult() { return event_result; }
}
